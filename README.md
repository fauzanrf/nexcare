...
Panduan untuk melakukan deployment dan testing telah dipisah ke file berikut:
- **[Deployment di Linux Server](DEPLOYMENT_LINUX.md)**
- **[Testing di Windows menggunakan XAMPP](TESTING_WINDOWS_XAMPP.md)**
