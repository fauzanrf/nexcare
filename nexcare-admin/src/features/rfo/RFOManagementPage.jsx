...
export default function RFOManagementPage() {
  ...
  const handleSave = (newData) => {
    if (editingItem) {
        // Update existing
        setRfos(prev => prev.map(item => item.id === newData.id ? { ...newData, createdBy: item.createdBy } : item));
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between"> 
        <h1 className="text-2xl font-bold text-gray-800 tracking-tight">RFO Management</h1>
