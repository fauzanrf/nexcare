...
import { StarlinkAddModal } from './StarlinkAddModal';
import { SuccessNotification } from '../../components/SuccessNotification';
import { db } from '../../lib/db';
import mascot from '../../assets/mascot.svg';

export default function StarlinkManagementPage() {
  const [data, setData] = useState(db.starlinkData || []);
  ...
  const handleSave = (item) => {
    if (editingItem) {
        ...
        showNotification('Starlink Account updated successfully!');
    } else {
        setData(prev => [item, ...prev]);
        showNotification('New Starlink Account added successfully!');
    }
    setEditingItem(null);
  };
  ...
  const handleDelete = (item) => {
    if (window.confirm(`Are you sure you want to delete ${item.name}?`)) {
        ...
        showNotification('Starlink Account deleted successfully!');
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between"> 
        <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Starlink Management</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            ...
            <div className="md:col-span-3 space-y-1">
                ...
                <div className="relative">
                    <Input 
                    placeholder="Search by Starlink Name, Email..." 
                    icon={Search}
